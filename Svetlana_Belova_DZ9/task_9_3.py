...
class Worker:
    ...
    def __init__(self, name: str, surname: str, position: str, _income: dict):
        self.name = name
        self.surname = surname
        self.position = position
        self._income =self.__dict__.update(_income)
...
class Position(Worker):
    ...
    def get_total_income(self) -> int:
        ...
        total = self.__dict__.get('wage') + self.__dict__.get('bonus')
        return total
